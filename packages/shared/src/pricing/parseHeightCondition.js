...
exports.parseHeightCondition = parseHeightCondition;
exports.heightInRange = heightInRange;
/**
 * Parsuje condition (np. "4,6-5 m", "5,01-6 m") na { min, max }.
 * Przecinek zamieniany na kropkę. Zwraca null przy błędzie (bez rzucania).
 */
function parseHeightCondition(condition) {
 ...
 */
function heightInRange(heightM, condition, minNum, maxNum) {
